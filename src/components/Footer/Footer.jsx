      ...
      <div className='container mx-auto'>
        <div className='flex justify-between items-start'>
          <a
            ...
            className="hover:text-[#B39567] transition-colors font-serif text-xl md:text-1xl font-bold"
          >
            institutobeja.org
          </a>
        </div>
        ...
        <div className='flex relative justify-between items-center mt-8 max-420:overflow-hidden'>
          <div className='flex flex-col space-y-2 text-2xl md:text-3xl font-serif'>
            <a
              ...
              target='_blank'
              rel='noopener noreferrer'
              className='hover:text-[#B39567] transition-colors flex items-center gap-2 font-serif text-xl md:text-2xl'
            >
