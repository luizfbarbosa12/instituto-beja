  ...
  return (
    <div className="py-12 px-4 sm:px-24">
      <div className="flex flex-col sm:flex-row justify-between items-end mb-8">
        <h1 className="text-3xl sm:text-6xl">Balanço</h1>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-bourdeaux text-white ">
                  <th className="py-2 px-2 sm:py-3 sm:px-4 text-left text-xs sm:text-lg">
                    PROJETO
                  </th>
                  <th className="py-2 px-2 sm:py-3 sm:px-4 text-right text-xs sm:text-base">
                    TOTAL DO<br/>APORTE EM R$
                  </th>
                  <th className="py-2 px-2 sm:py-3 sm:px-4 text-right text-xs sm:text-base">
                    TOTAL 2024<br/>EM R$
                  </th>
                  <th className="py-2 px-2 sm:py-3 sm:px-4 text-center text-xs sm:text-base">
                    INÍCIO
                  </th>
                  <th className="py-2 px-2 sm:py-3 sm:px-4 text-center text-xs sm:text-base">
                    CONCLUSÃO
      ...
      {data.tableData.map((section, sectionIndex) => (
        <div key={sectionIndex} className="mt-4 sm:mt-8">
          {section.category && (
            <div className="bg-retro-ochre rounded-3xl py-1 px-2 sm:py-2 sm:px-4 font-bold text-xs sm:text-sm">
              {section.category}
            </div>
          )}
