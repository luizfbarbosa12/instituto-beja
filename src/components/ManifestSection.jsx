...
const ManifestSection = () => {
  return (
    <div className='relative flex flex-col items-center gap-12 w-full bg-porcelain'>
      <div className='flex justify-between w-full [&>p]:leading-none editorial text-2xl z-10'>
        <p>
          www.
          <br />
          institutobeja.org
